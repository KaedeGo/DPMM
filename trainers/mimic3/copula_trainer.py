...
class CopulaTrainer(Trainer):
    def __init__(self, 
        ...
        self.model = Copula_Fusion(args, self.ehr_model, self.note_model).to(self.device)
        ...
        self.epochs_stats = {'loss train': [], 'loss val': [], 'auroc val': [], 'auroc test': [],
                             'loss copula train': [], 'loss copula val': [], 'loss align train': [],
                             'loss align val': []}
            ...
            wandb.log(
                {
                    ...
                    "val_auroc_ci": ret["ci_auroc"],
                    "val_auprc_ci": ret["ci_auprc"]
                }
            )
            ...
            wandb.log(
                {
                    ...
                    "test_auroc_ci": ret["ci_auroc"],
                    "test_auprc_ci": ret["ci_auprc"]
                }
            )
