...
if __name__ == "__main__":
    ...
    pos_val = 0
    pos_test = 0
    for i, (x, img, y_ehr, y_cxr, seq_lengths, pairs) in enumerate(train_dl):
        pos_train += y_ehr.sum(axis=0)
    for i, (x, img, y_ehr, y_cxr, seq_lengths, pairs) in enumerate(val_dl):
        pos_val += y_ehr.sum(axis=0)
    for i, (x, img, y_ehr, y_cxr, seq_lengths, pairs) in enumerate(test_dl):
...
"""
    ...
    total: ehr_files_all: 25071, ehr_files_paired: 5931, cxr_files_all: 378095, cxr_files_paired: 5931, ehr_files_unpaired: 19040

    Data Pairs: partial_ehr_cxr, Positives: Train: 3321, Val: 382, Test: 900, Total: 4603
    Data Pairs: paired_ehr_cxr, Positives: Train: 904, Val: 105, Test: 253, Total: 1262
