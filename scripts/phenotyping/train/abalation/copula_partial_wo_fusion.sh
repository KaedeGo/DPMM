...
--save_dir checkpoints/phenotyping/abalation/copula_partial_wo_fusion

# nohup sh scripts/phenotyping/train/abalation/copula_partial_wo_fusion.sh > logs/phe_mimic4/abalation/copula_partial_wo_fusion.log 2>&1 &
