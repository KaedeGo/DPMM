...
--save_dir checkpoints/readm/abalation/copula_paired_wo_fusion
# nohup sh scripts/readmission/train/abalation/copula_paired_wo_fusion.sh > logs/readm_mimic4/abalation/copula_paired_wo_fusion.log 2>&1 &