...
--save_dir checkpoints/readm/abalation/copula_partial_wo_resample.5
# nohup sh scripts/readmission/train/abalation/copula_partial_wo_resample.sh > logs/readm_mimic4/abalation/copula_partial_wo_resample.log 2>&1 &