...
--save_dir checkpoints/readm/mimic3/partial/copula1
# nohup sh scripts/readmission/mimic3/param/copula_partial.sh > logs/readm_mimic3/partial/copula1.log 2>&1 &