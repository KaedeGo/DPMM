...
--save_dir checkpoints/mortality/mimic3/partial/copula1
# nohup sh scripts/mortality/mimic3/param/copula_partial.sh > logs/ihm_mimic3/partial/copula1.log 2>&1 &