...
--save_dir checkpoints/mortality/abalation/copula_partial_wo_resample.5
# nohup sh scripts/mortality/train/abalation/copula_partial_wo_resample.sh > logs/ihm_mimic4/abalation/copula_partial_wo_resample.log 2>&1 &