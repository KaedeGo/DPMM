...
--save_dir checkpoints/mortality/abalation/copula_paired_wo_fusion
# nohup sh scripts/mortality/train/abalation/copula_paired_wo_fusion.sh > logs/ihm_mimic4/abalation/copula_paired_wo_fusion.log 2>&1 &