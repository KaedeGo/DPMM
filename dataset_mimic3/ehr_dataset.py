...
if __name__ == "__main__":
    ...
    print("len(ehr_train_ds):", len(ehr_train_ds))
    print("len(ehr_val_ds):", len(ehr_val_ds))
    print("len(ehr_test_ds):", len(ehr_test_ds))

    '''
    phenotyping_48h & ihm:
    len(ehr_train_ds): 14681
    len(ehr_val_ds): 3222
    len(ehr_test_ds): 3236
    '''