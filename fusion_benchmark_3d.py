...
from trainers.triple.dp_trainer import DirichletProcessTrainer
            ...
            for rho_scale in [-2.5, -3, -3.5, -4]:
                for K in [2, 3, 4, 5]:
                    for eta in [0.1, 0.5, 1, 2, 5]:
                        ...
                        name = f"{dataset_name}_3D_{args.fusion_type}_{pair_type}_{args.labels_set}_rho{rho_scale}_K{K}_temp{args.temperature}"
                        config = vars(args)
                        mode = "online"
